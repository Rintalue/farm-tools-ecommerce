defmodule Project2.Vendors.Vendor do
  use Ecto.Schema
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Project2.Repo)
  ...
  """
  def valid_password?(%Project2.Vendors.Vendor{hashed_password: hashed_password}, password)
