defmodule Project2.Vendors do
  ...
  alias Project2.Vendors.{Vendor, VendorToken, VendorNotifier}
  ...
  defp confirm_vendor_multi(vendor) do
    ...
    |> Ecto.Multi.delete_all(:tokens, VendorToken.by_vendor_and_contexts_query(vendor, ["confirm"]))
  end
