defmodule Project2Web.VendorAuth do
  ...
  the current_vendor:
      ...
      defmodule Project2Web.PageLive do
        ...
        on_mount {Project2Web.VendorAuth, :mount_current_vendor}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{Project2Web.VendorAuth, :ensure_authenticated}] do
