defmodule Project2Web.VendorRegistrationLive do
  use Project2Web, :live_view

  alias Project2.Vendors
  alias Project2.Vendors.Vendor
  ...
  def render(assigns) do
    ...
    <div class="mx-auto max-w-sm">
      <.header class="text-center">
        ...
        <:subtitle>
          Already registered?
          <.link navigate={~p"/vendors/log_in"} class="font-semibold text-brand hover:underline">
            Log in
          </.link>
          to your account now.
        </:subtitle>
      ...
      <.simple_form
        ...
        action={~p"/vendors/log_in?_action=registered"}
        method="post"
      >
